 ...
 * Description : GoogleSignInFragment responsible for  Google Sign in activity
 *
 */
public  class GoogleSignInFragment extends Fragment implements
    ...
    public void onStart() {
        ...
        if (opr.isDone()) {
            ...
            Log.v("resultIs",result.toString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            Log.v("resultIs", Boolean.toString(result.isSuccess()));
            Log.v("emailIs",result.getSignInAccount().getEmail());
            Log.v("Nameis",result.getSignInAccount().getDisplayName());
    ...
    /**
     *
     * @param result Google signIn Result object
     */
