 ...
 * Description : FacebookLoginFragment responsible for  Facebook Sign in activity
 *
 */
public class FacebookLoginFragment extends Fragment {
    ...
    private void homeFragment(Profile profile) {
        ...
        if (profile != null) {
            ...
            FacebookHomeFragment hf = new FacebookHomeFragment();
            hf.setArguments(mBundle);

            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager
                    .beginTransaction();
            fragmentTransaction.replace(R.id.mainContainer, new FacebookHomeFragment());
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        loginButton = (LoginButton) view.findViewById(R.id.Login_FacebookButton);
